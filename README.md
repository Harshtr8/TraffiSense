...
Usage
Load the Traffic Simulation: Run the Jupyter Notebook and load your CCTV feed (or a simulated video file). The system will automatically start detecting traffic conditions and emergency vehicles.

Observe Traffic Light Adjustments: Watch as the system adjusts traffic light timings in real time, providing priority to emergency vehicles while maintaining overall traffic flow.

Customization: Modify the traffic light timing rules, lane configurations, and emergency vehicle detection parameters to adapt the system to different city setups.
